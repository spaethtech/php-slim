...
class Application extends App
{
    ...
    /**
     * Simplifies the addition of a {@see Controller}s.
     *
     * @param Controller $controller A {@see Controller} to add to the application.
     *
     * @return RouteGroupInterface Returns the added {@see Controller} to accommodate method chaining.
     */
